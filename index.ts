...
export const PaymentBankTransferModule: StorefrontModule = function ({ store }) {
  ...
  if (!isServer) {
    ...
    EventBus.$on('checkout-payment-method-changed', (paymentMethodCode) => {
      ...
      if (methods) {
        ...
        if (paymentMethodCode === METHOD_CODE && ((typeof method !== 'undefined' && !method.is_server_method) || typeof method === 'undefined')) {
